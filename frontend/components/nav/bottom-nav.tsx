      ...
      <div className="mx-auto flex max-w-lg items-center justify-around p-2">
        ...
        {onAdd && (
          <button
            ...
            className="-mt-6 flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg transition-transform hover:scale-105 active:scale-95"
          >
